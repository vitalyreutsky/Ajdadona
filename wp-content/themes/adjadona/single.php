            ...
            <div class="container">
               <ul class="breadcrumbs__list list-reset">
                  <li class="breadcrumbs__item-back">
                     <a href="<?php echo home_url('/catalogue'); ?>" class="breadcrumbs__link breadcrumbs__link-back"><svg>
                  ...
                  <li class="breadcrumbs__item breadcrumbs__item-main">
                     <a href="<?php echo home_url('/maison'); ?>" class="breadcrumbs__link breadcrumbs__link--active"><?php the_title(); ?></a>
                  </li>
               </ul>
            </div>
         </div>
      <?php elseif (ICL_LANGUAGE_CODE == 'en') : ?>
         <div class="breadcrumbs">
            <div class="container">
               <ul class="breadcrumbs__list list-reset">
                  <li class="breadcrumbs__item-back">
                     <a href="<?php echo home_url('/product'); ?>" class="breadcrumbs__link breadcrumbs__link-back"><svg>
                           <use xlink:href="<?php echo get_template_directory_uri(); ?>/assets/img/sprite-98721a2dbd.svg#back"></use>
                        </svg>
                        Back</a>
                  </li>
                  ...
                  <li class="breadcrumbs__item breadcrumbs__item-main">
                     <a href="<?php echo home_url('/home'); ?>" class="breadcrumbs__link breadcrumbs__link--active"><?php the_title(); ?></a>
                  </li>
               </ul>
            </div>
         </div>
         ...
         <div class="products__inner">
            ...
            <div class="single-product__content">
               <div class="single-product__card">
                  <div class="single-product__card-image">
                     <?php the_post_thumbnail(); ?>
                  </div>
                  <div class="single-product__card-descr">
                     <div class="single-product__card-list">
                        <?php the_content(); ?>
                     </div>
                  </div>
                  <h3 class="single-product__card-title"><?php the_title(); ?></h3>
               </div>
               <?php if (ICL_LANGUAGE_CODE == 'en') : ?>
                  <button onclick="window.history.back()" class="btn-reset btn form__btn single-product__btn">Back</button>
               <?php elseif (ICL_LANGUAGE_CODE == 'fr') : ?>
                  <button onclick="window.history.back()" class="btn-reset btn form__btn single-product__btn">Retour</button>
               <?php endif; ?>
            </div>
         </div>
      </div>
